    ...
    return(
        ...
        <section className="welcome">
            <div className="welcome_section_title">
              <h1 className="title">General information  <span>about</span> this project</h1>
                <div className="description">                  
                  <p className="description_text">
                  GraphiQL is a playground/IDE for graphQL requests. 
                  In this project you can authenticate and register using Firebase technology with login method by email and password.
                  After logging in you will be taken to GraphiQL page with:<br/>
                  request editor (query editor / JSON viewer);<br/>
                  variables editor;<br/>
                  headers editor;<br/>
                  documentation explorer;<br/>
                  response section (query editor / JSON viewer);<br/>
                  possibility to change to a different user-specified API endpoint;<br/>
                  </p>
                </div>
            </div>
        </section>
        ...
        <h2 className="about_title">This project was developed by  <span>frontend developers:</span></h2>
        ...
        <section className="about-course">
          ...
          <div className="about-course_img">
                ...
                <div className="course-description">
                  ...
                  Start date: October 23, 2023<br/>
                  Students of the RS School from the 2022Q3, which has passed RS School Stage #2 as well as new students with practical experience and knowledge of:<br/>

    JavaScript;<br/>
TypeScript;<br/>
Git, GitHub (clone, add, commit, push, pull, merge, rebase, working with Pull Request);<br/>
NPM, Webpack;<br/>
CSS3 / HTML5;<br/>
